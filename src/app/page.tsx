...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 selection:bg-primary/20 selection:text-primary overflow-x-hidden" style={{ fontFamily: BRAND.fonts.body }}>
            ...
            >
              <div className="lg:sticky lg:top-32">
                ...
                <div className="space-y-6 text-lg text-neutral-600 leading-relaxed">
                  <p>
                    Founded in 2004 as a boutique tailoring unit in Vadodara's industrial belt, Rekha Garments has grown into a trusted manufacturing partner for enterprises across India. What began with three sewing machines now operates across 18,000 sq. ft. of production space.
                  </p>
                  <p>
          ...
          <div className="border-t border-neutral-700/50 pt-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-neutral-400 text-sm">
                <p>&copy; 2004 Rekha Garments. All rights reserved.</p>
      ...
      >
        <Button
          className="w-16 h-16 rounded-full bg-accent text-white shadow-2xl hover:bg-accent/90 border-4 border-white flex flex-col items-center justify-center gap-1 group overflow-hidden relative"
          onClick={() => router.push('/product-catalogue?tab=gallery')}
        >
