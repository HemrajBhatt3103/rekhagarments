        ...
        <nav className="container mx-auto px-4 relative">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              {['Home', 'About', 'Leadership', 'Solutions', 'Process', 'Product catalogue', 'Contact'].map((item, index) => {
                // Handle smooth scroll for home page sections
                const handleNavigation = () => {
                  if (item === 'Home') {
                    window.scrollTo({ top: 0, behavior: 'smooth' });
                  } else if (['About', 'Leadership', 'Process', 'Solutions', 'Contact'].includes(item)) {
                    scrollToSection(item.toLowerCase());
                  } else {
                    // For new pages, navigate to their routes
            ...
            >
              <div className="inline-flex items-center justify-center bg-accent/10 text-accent px-6 py-3 rounded-full border border-accent/20 mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-lg font-bold italic" style={{ fontFamily: BRAND.fonts.heading }}>
                    "Quality Is Our Symbol"
                  </span>
                  <TargetIcon className="w-5 h-5" />
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-neutral-600">
              Blending decades of expertise with next-generation vision for sustainable growth.
            </p>
          </motion.div>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <div className="inline-flex items-center space-x-2 mb-4">
                      <div className="h-0.5 w-8 bg-accent"></div>
                      <span className="text-accent font-bold uppercase tracking-widest text-sm">Founder's Note</span>
                    </div>
                    ...
                    <p className="text-neutral-600 mb-4 italic">
                      "Quality Is Our Symbol" is more than a slogan — it is the foundation of Rekha Garments.
                      From careful fabric selection to precise stitching, accurate sizing, and flawless finishing,
                      every garment is produced with an uncompromising commitment to quality. Years of experience
                      in garment manufacturing and wholesale have taught us that true trust is built through consistency, not promises.
                    </p>
                    <p className="text-neutral-600 mb-4 italic">
                      At Rekha Garments, we believe that quality reflects integrity. That is why we focus on honest
                      workmanship, fair pricing, and reliable delivery for every order. Our goal has always been to
                      build long-term partnerships by delivering products our customers can depend on — today and in the years to come.
                    </p>
                    <div className="mt-6 pt-6 border-t border-neutral-200/30">
                      <div className="font-bold text-neutral-900">— Rajkumar B. Lalwani</div>
                      <div className="text-sm text-neutral-500">Proprietor, Rekha Garments</div>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                name: "Rajkumar Lalwani",
                role: "Founder & Proprietor",
                experience: "20+ Years Experience",
                description: "With over two decades of experience in garment manufacturing and wholesale, Rajkumar Lalwani is the foundation behind Rekha Garments. His deep expertise in fabric selection, production standards, pricing ethics, and customer relationships has shaped the company into a trusted name in the market. Guided by the belief 'Quality Is Our Symbol', he continues to lead the business with integrity, consistency, and a long-term vision.",
                icon: User,
              ...
              },
              {
                ...
                experience: "MBA Student | Next-Gen Leader",
                description: "At 22 years of age, Vishnu Lalwani represents the next generation of operational leadership. Currently pursuing an MBA, he actively supports the business by managing day-to-day operations, production coordination, quality monitoring, and workflow efficiency. By combining academic management principles with hands-on manufacturing exposure, he ensures smooth execution while upholding the company's quality standards.",
                icon: UsersIcon,
                color: "from-blue-500/10 to-blue-600/5"
              },
              {
                name: "Mahesh Lalwani",
                role: "Sales Head – Wholesale Division",
                experience: "BBA Student | Sales Management",
                description: "Mahesh Lalwani leads the wholesale sales division for readymade garments. At 20 years old and currently pursuing a BBA, he works closely with his father to manage bulk sales, client coordination, and market outreach. His role focuses on understanding buyer needs, supporting transparent pricing, and building long-term relationships, with a clear vision to contribute to the future growth and expansion of the business.",
                icon: Target,
              ...
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 border border-neutral-200/50">
                  <CardContent className="p-6">
                    <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${leader.color} flex items-center justify-center mb-4`}>
                      <leader.icon className="w-8 h-8 text-primary" />
                    </div>
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">{leader.name}</h3>
                    ...
                    <p className="text-neutral-600 text-sm">{leader.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-gradient-to-r from-primary to-primary/90 text-white p-8 rounded-2xl shadow-xl">
              <h3 className="text-2xl font-bold mb-6 text-center" style={{ fontFamily: BRAND.fonts.heading }}>
                Leadership Philosophy
              </h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  { icon: Shield, text: "Quality-driven manufacturing" },
                  { icon: Heart, text: "Ethical business practices" },
                  { icon: Users, text: "Customer-centric solutions" },
      ...
      <section className="py-24 bg-gradient-to-b from-neutral-50/50 to-white">
        <div className="container mx-auto px-4">
          <motion.div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-neutral-600">
              End-to-end apparel manufacturing for corporate, educational, and festive needs.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Briefcase,
                title: "Corporate Uniforms",
                items: ["Company T-shirts", "Polo T-shirts", "Staff Uniforms", "Doctor Coats"],
                color: "from-primary/5 to-primary/10",
                link: "#contact"
              },
              {
                ...
                items: ["School T-shirts", "Track Pants", "Complete Sets", "Bulk Orders"],
              ...
              },
              {
                ...
                items: ["Ganpati T-shirts", "Festive Prints", "Themed Apparel", "Seasonal Collections"],
                color: "from-orange-500/5 to-orange-600/10",
                link: "/festive-clothing"
              },
              {
                icon: ShoppingBag,
                title: "Custom & Promotional",
                items: ["Plain T-shirts", "Round Neck Tees", "Custom Printed", "Event T-shirts"],
              ...
              },
              {
                ...
                items: ["Various Colors", "Multiple Fabrics", "Round Neck", "Custom Sizing"],
                color: "from-neutral-50 to-white",
                link: "#contact"
              },
              {
                ...
                items: ["Sports T-shirts", "Team Uniforms", "Athletic Wear", "Casual Sportswear"],
              ...
              },
              {
                ...
                items: ["Aprons", "Doctor Coats", "Lab Coats", "Industrial Uniforms"],
              ...
              },
              {
                icon: Package,
                title: "Bulk Orders",
                items: ["Corporate Groups", "Schools", "Events", "Organizations"],
              ...
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 border border-neutral-200/50 group cursor-pointer" onClick={() => {
                  if (category.link.startsWith('/')) {
                    window.location.href = category.link;
                  } else {
                    scrollToSection(category.link.replace('#', ''));
                  }
                }}>
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-neutral-900 mb-3">{category.title}</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-6 mb-6">
              <Badge className="bg-white text-neutral-800 border-neutral-200/50 shadow-sm">What Customers Say About Us</Badge>

              {/* Google Reviews Badge */}
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
                <div className="flex items-center bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-3 rounded-full border border-blue-200 shadow-sm">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-600">Google Business Rating</div>
                    </div>
                  </div>
                </div>

                <div className="flex items-center bg-gradient-to-r from-green-50 to-green-100 px-6 py-3 rounded-full border border-green-200 shadow-sm">
                  <div className="flex items-center">
                    <div className="bg-white p-2 rounded-lg mr-3">
                      <Users className="w-6 h-6 text-green-600" />
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-neutral-900">290+</div>
          ...
          >
            <Button
              ...
              onClick={() => window.open('https://www.google.com/search?client=firefox-b-d&hs=4XMU&sca_esv=3b5cf2041e18d574&si=AMgyJEtREmoPL4P1I5IDCfuA8gybfVI2d5Uj7QMwYCZHKDZ-E0dHSyHb8Ymwkr3hp9GOjRzSpnR1yRRM2KRdWvtds8MWR-tHdRuLyi5WZMQQwZUSdFdaf0Ilduqz-ogn36Zc-jM9l8A6RNAo4XJJ2c_wEMQG0aMonFogMG_HTzuzV2cKkqN5kh1qLUXbfCMqKMf0qXhIbI47hkiTU4pyU-nbHedSyPdWBGUNdR1F-rGD10-IYKFThlxx8qSAj_kRxpeRad1nOb5fzq7I8KarpjnLOuriWkqvwA%3D%3D&q=Rekha+Garments%7CManufacturer+%26+Wholesaler%7CPlain+Tshirts%7CCustomized+Polo+Tshirt%7CSchool%7CCompany%7CGanpati%7CGanesh%7CCorporate+T-shirt+Reviews&sa=X&ved=2ahUKEwim0u2UttORAxVeUGcHHaJBPRMQ0bkNegQIJhAD&biw=1536&bih=703&dpr=1.25', '_blank')}
            >
              <Star className="w-4 h-4 mr-2 fill-current" />
              View All 290+ Reviews on Google
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <div className="mt-4 inline-flex items-center bg-accent/10 text-accent px-3 py-1 rounded-full border border-accent/20">
                <TargetIcon className="w-3 h-3 mr-1" />
                <span className="text-xs font-medium italic">"Quality Is Our Symbol"</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {['About Us', 'Leadership Team', 'Manufacturing Process', 'Quality Standards', 'Client Stories', 'Contact'].map((item, i) => (
                  <button
                    key={i}
                    onClick={() => {
...
//             <div className="hidden lg:flex items-center space-x-8">
//               {['Home', 'About', 'Solutions', 'Process', 'School Uniforms', 'Festive Clothing', 'Contact'].map((item, index) => {
//                 // Handle smooth scroll for home page sections
//                 const handleNavigation = () => {
//                   if (item === 'Home') {
//                     window.scrollTo({ top: 0, behavior: 'smooth' });
...
//                 transition={{ duration: 0.5, delay: index * 0.05 }}
//               >
//                 <Card className="h-full hover:shadow-xl transition-all duration-300 border border-neutral-200/50 group cursor-pointer" onClick={() => window.location.href = category.link}>
//                   <CardContent className="p-6">
//                     <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${category.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
//                       <category.icon className="w-6 h-6 text-primary" />
//                     </div>
