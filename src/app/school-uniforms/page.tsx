                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Button
                                size="lg"
                                className="bg-white text-blue-700 hover:bg-white px-8 py-6 text-lg border-none shadow-lg"
                                onClick={scrollToHomeContact}
                            >
                                <FileText className="w-5 h-5 mr-2" />
                            ...
                            <Button
                                size="lg"
                                className="bg-white text-blue-700 hover:bg-white hover:text-blue-700 px-8 py-6 text-lg border-none shadow-lg"
                                onClick={() => window.open(whatsappUrl, '_blank')}
                            >
